...
public class ConfirmDialog extends javax.swing.JDialog {
     ...
     * @param type
     */
    public ConfirmDialog(java.awt.Frame parent, boolean modal,  String title, String text, String type) {
        super(parent, modal);
        ...
        JButton nextButton = new JButton(Utility.getBundleString("confirm", bundle));
        ...
        JButton  prevButton = new JButton(Utility.getBundleString("annulla", bundle));
