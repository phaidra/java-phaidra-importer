...
public class Vocabulary {
  ...
  private ResourceBundle bundle = ResourceBundle.getBundle(Globals.RESOURCES, Globals.CURRENT_LOCALE, Globals.loader);
  ...
  private TreeMap<String,VocEntry> get_vocabulary_entries(Element iInnerNode) throws Exception{
    ...
    String DE_VOC = null;
    String sLang = Globals.CURRENT_LOCALE.toString();
