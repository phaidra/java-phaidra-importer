    ...
    protected class Task extends SwingWorker<Void, Void> {
        ...
        private void importPdf() {
            ...
            if (System.getProperty("os.name").toLowerCase().startsWith("win")) {
                System.load(BookImporter.jrPath+"lib"+Utility.getSep()+"gsdll32.dll");
            }
            ...
            try {
                ...
                String prefix = BookImporter.selectedFolderSep + "autogen";
                String suffix = "jpg";
        ...
        private void exportPdf() {
            ...
            try {
                ...
                for (int i = 0; i < images.size(); i++) {
                    ...
                    mimetype = Utility.getMimeType(BookImporter.selectedFolderSep + images.get(i));
                    if (Utility.fileIsPicture(mimetype)) {
                        if(mimetype.equals("image/tiff"))
                            img = Image.getInstance(BookImporter.selectedFolderSep + images.get(i));
                        else
                            img = Image.getInstance(Utility.convertImage(BookImporter.selectedFolderSep + images.get(i), quality));
